/**
 * @name ClearVision Ruby
 * @author Zerthox
 * @version 6
 * @description ClearVision v6.
 * @source https://github.com/ClearVision/v6
 * @website https://clearvision.gitlab.io/join
 */
...
:root {
	...
	/* ACCENT COLORS */
	--main-color: #e62727; /* main accent color (hex, rgb or hsl) [default: #2780e6] */
	--hover-color: #b31e1e; /* hover accent color (hex, rgb or hsl) [default: #1e63b3] */
	...
	/* GENERAL */
	--main-font: gg sans, Helvetica Neue, Helvetica, Arial, sans-serif; /* main font for app (font must be installed) [default: Whitney, Helvetica Neue, Helvetica, Arial, sans-serif] */
	...
	--background-image: url(https://clearvision.github.io/images/ruby.jpg); /* app background image (link must be HTTPS) [default: url(https://clearvision.gitlab.io/images/sapphire.jpg)]*/
	...
	--text-muted:  rgb(114, 118, 125); /* color of default discord muted text (text found in input fields before typing).*/
